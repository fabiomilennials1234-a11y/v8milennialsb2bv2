...
INSERT INTO public.pipeline_entries
  (id, organization_id, pipeline_id, lead_id, stage_id, stage_key, entered_at) VALUES
  ('3680c17e-0000-4000-8000-0000000000c5', '36800000-0000-4000-8000-00000000000c',
   ...
   '36805747-0000-4000-8000-00000000000c', 'prospect', '2027-08-14T12:00:00Z'),
  ('3680c17e-0000-4000-8000-0000000000d1', '36800000-0000-4000-8000-00000000000d',
   ...
   '36805747-0000-4000-8000-00000000000d', 'prospect', '2027-08-14T12:00:00Z')
ON CONFLICT (id) DO NOTHING;
