...
run_with_pg_prove() {
  pg_prove --verbose --ext .sql -d "$DATABASE_URL" \
    ...
    "$SCRIPT_DIR/workflow_deal_created_pipeline_filter_test.sql" \
    "$SCRIPT_DIR/workflow_deal_created_stage_filter_test.sql" \
    "$SCRIPT_DIR/pipeline_stage_delete_workflow_impact_test.sql" \
