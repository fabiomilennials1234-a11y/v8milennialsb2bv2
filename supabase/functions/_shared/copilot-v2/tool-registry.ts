...
export const TOOL_REGISTRY: ToolMeta[] = [
  ...
  { name: "send_media", kind: "write", capability: "can_send_media", description: "Envia mídia da biblioteca aprovada quando o gatilho casa (gate de momento/repetição no harness).", parameters: obj({ media_id: str("id do item da biblioteca") }, ["media_id"]) },
