...
export function getCorsHeaders(origin?: string | null): Record<string, string> {
  ...
  return {
    ...
    "Access-Control-Allow-Headers": "authorization, x-client-info, apikey, content-type, x-cron-secret, x-webhook-key, x-api-key, x-api-version, x-user-jwt, x-internal-api-key",
