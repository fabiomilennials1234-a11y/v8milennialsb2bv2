...
export { sendWhatsAppAudio, sendWhatsAppImage, sendWhatsAppSticker, sendWhatsAppDocument, sendWhatsAppVideo } from "./send-whatsapp-media.ts";
...
import { sendWhatsAppAudio, sendWhatsAppImage, sendWhatsAppSticker, sendWhatsAppDocument, sendWhatsAppVideo } from "./send-whatsapp-media.ts";
...
export const handlers: Record<string, ActionHandler> = {
  ...
  send_whatsapp_video: sendWhatsAppVideo,
