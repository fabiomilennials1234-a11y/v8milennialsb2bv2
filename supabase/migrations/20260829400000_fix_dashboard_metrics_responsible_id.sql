-- Fix dashboard metrics RPC: add responsible_id fallback to ALL member filters
-- This fixes: Propostas Enviadas=0, Taxa de Conversão=0%, Receita por Tipo=0
-- Root cause: filters used only closer_id but data often uses responsible_id
