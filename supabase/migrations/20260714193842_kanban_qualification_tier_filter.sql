...
-- version: 20260714193842  name: kanban_qualification_tier_filter
...
CREATE FUNCTION public.get_pipeline_page(
  p_pipeline_slug text, p_stage_id text, p_org_id uuid, p_page_size integer DEFAULT 20,
  p_cursor timestamptz DEFAULT NULL, p_search text DEFAULT NULL,
  p_responsible_id uuid DEFAULT NULL, p_tag_ids uuid[] DEFAULT NULL, p_origins text[] DEFAULT NULL,
  p_rating_min integer DEFAULT NULL, p_rating_max integer DEFAULT NULL,
  p_calor_min integer DEFAULT NULL, p_calor_max integer DEFAULT NULL,
  p_urgency text DEFAULT NULL, p_product_type text DEFAULT NULL,
  p_meeting_after timestamptz DEFAULT NULL, p_meeting_before timestamptz DEFAULT NULL,
  p_period_after timestamptz DEFAULT NULL, p_period_before timestamptz DEFAULT NULL,
  p_closed_status_keys text[] DEFAULT NULL, p_updated_before timestamptz DEFAULT NULL,
  p_overdue_exclude_status_keys text[] DEFAULT NULL, p_status_keys text[] DEFAULT NULL,
  p_scheduled boolean DEFAULT NULL,
  p_qualification_tier text[] DEFAULT NULL, p_pre_qualification_tier text[] DEFAULT NULL
)
...
BEGIN
  SELECT p.id INTO v_pipeline_id FROM public.pipelines p WHERE p.slug=p_pipeline_slug AND p.type='system' AND p.organization_id=p_org_id;
...
CREATE FUNCTION public.get_pipeline_stage_counts(
  p_pipeline_slug text, p_org_id uuid, p_search text DEFAULT NULL,
  p_responsible_id uuid DEFAULT NULL, p_tag_ids uuid[] DEFAULT NULL, p_origins text[] DEFAULT NULL,
  p_rating_min integer DEFAULT NULL, p_rating_max integer DEFAULT NULL,
  p_calor_min integer DEFAULT NULL, p_calor_max integer DEFAULT NULL,
  p_urgency text DEFAULT NULL, p_product_type text DEFAULT NULL,
