-- ============================================================================
-- Grupo sai da lista de conversas, no servidor (PRD #1629, fatia #1632)
--
-- `capture_groups` esta `false` nas 104 orgs e o whatsapp-webhook dropa
-- mensagem de grupo, entao nao entra grupo novo -- o que sobrava era historico
-- congelado atras de um toggle que o proprio membro ligava.
--
-- O recorte estava SO no cliente: get_whatsapp_conversation_list devolvia
-- grupo e o navegador descartava. Grupo e 978.756 de 2.472.395 mensagens
-- (40%), e a lista baixa ate 8.000 linhas por chip.
--
-- Unica mudanca em relacao a definicao anterior: `AND s.is_group = false` no
-- CTE `chip`, antes do LIMIT.
-- ============================================================================
