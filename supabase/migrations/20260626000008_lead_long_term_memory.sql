...
-- Índice HNSW para busca semântica em memórias
...
-- Função: busca memórias semanticamente relevantes para um lead
...
COMMENT ON FUNCTION match_lead_memories IS
  'Busca semântica por memórias relevantes de um lead para o contexto atual da conversa.';
