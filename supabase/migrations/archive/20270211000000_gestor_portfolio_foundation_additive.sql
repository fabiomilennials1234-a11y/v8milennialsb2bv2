-- 20270211000000_gestor_portfolio_foundation_additive.sql
-- S1 #1137 — Gestor de Portfólio: fundação ADITIVA (ADR-0021).
--
-- APLICADA EM PROD via MCP em 2026-07-19 (branch de prod falhou por drift; validada
-- direto no schema real). Segura: cria 2 tabelas novas + 1 helper novo. NÃO altera
-- get_my_organization_ids nem get_my_admin_organization_ids — o swap com união é
-- HITL-gated e vive em 20270211000001 (NÃO aplicar sem review de segurança).
...
--    será unido aos 2 helpers quentes no swap HITL-gated.
