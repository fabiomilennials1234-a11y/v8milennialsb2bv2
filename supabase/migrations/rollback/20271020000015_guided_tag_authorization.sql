-- Stop guided admission first. Preserve tag approval and execution history.
BEGIN;
...
DROP FUNCTION IF EXISTS public.read_guided_condition_data(uuid,uuid,uuid,text[],uuid[]);
