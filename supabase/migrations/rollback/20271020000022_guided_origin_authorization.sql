-- Restore pre-origin functions; retain expanded CHECK, catalogue and approval/version data.
BEGIN;
DROP FUNCTION IF EXISTS public.read_guided_condition_data(uuid,uuid,uuid,text[],uuid[],uuid[]);
