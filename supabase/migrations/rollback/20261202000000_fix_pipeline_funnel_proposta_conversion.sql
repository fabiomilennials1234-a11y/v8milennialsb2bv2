-- ROLLBACK SP-0 fix #6: restaura get_analytics_pipeline_metrics ao bloco ORIGINAL
-- verbatim de 20261114000011_guard_definer_analytics_rpcs.sql (linhas 1454-1906).
-- Reintroduz os bugs (Reunião→Proposta = attended/attended = 100%; Proposta→Venda = won/attended).
