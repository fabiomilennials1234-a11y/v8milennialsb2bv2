-- ROLLBACK SP-0 fix: soft-delete leak — restaura get_analytics_financial_metrics + get_analytics_overview_metrics verbatim (blocos originais de 20261114000011_guard_definer_analytics_rpcs.sql, linhas 682-922 e 924-1452). Ver docs/superpowers/specs/2026-07-02-metrics-foundation-design.md
