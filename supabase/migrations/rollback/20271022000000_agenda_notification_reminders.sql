-- Restore the previous reminder functions and schedules; keep notification history.
...
ALTER TABLE public.notifications ALTER COLUMN last_event_at DROP DEFAULT;
DROP INDEX IF EXISTS public.notifications_reminder_lookup_idx;
DROP INDEX IF EXISTS public.pipeline_entries_pending_meeting_reminder_idx;
DROP INDEX IF EXISTS public.follow_ups_pending_reminder_date_idx;
