-- Restore prior field authorization/readers/finalizer. Keep wider CHECK and all data.
BEGIN;
...
BEGIN
  ...
  IF jsonb_typeof(p_definition) IS DISTINCT FROM 'object'
    ...
    OR NOT (p_required_fields <@ ARRAY['lead.name','lead.company','lead.email','lead.phone','lead.tags']::text[]) THEN
