-- Keep the wider CHECK/helper and approval history; disable custom execution.
BEGIN;
DROP FUNCTION IF EXISTS public.read_guided_condition_custom_data(uuid,uuid,uuid,text[],uuid[],uuid[],uuid[]);
