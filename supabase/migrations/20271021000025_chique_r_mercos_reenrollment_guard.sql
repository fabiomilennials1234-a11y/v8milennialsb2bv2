-- Chique Distribuidora approved reenrollment for R. mercos after media audit.
-- Keep the emergency Agafarma exception and leave all other tenants untouched.
...
BEGIN
  ...
  IF NOT FOUND THEN
    RAISE EXCEPTION 'R. mercos is not an active, disabled workflow in Chique';
  END IF;
END;
$$;
