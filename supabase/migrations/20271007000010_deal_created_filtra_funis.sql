-- GitHub #2003 / SCRUM-676
--
-- O matcher de banco barra funis incompatíveis antes do INSERT da execução.
-- Ausência/lista vazia = qualquer funil; forma presente inválida = fail-closed.
