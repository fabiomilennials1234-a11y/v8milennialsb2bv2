-- 20270812100000_metric_taxa_qualidade.sql
--
...
--     20270811170000  metric_tempo_resposta_equipe ✗ payment_link_charges_method_do_port
...
--
-- ROLLBACK pareado: rollback/20270812100000_metric_taxa_qualidade.sql
