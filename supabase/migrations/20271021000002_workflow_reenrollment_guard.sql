-- Enforce enrollment settings at the common boundary for all producers.
...
BEGIN
  ...
  SELECT count(*), max(started_at) INTO previous_count, latest_start
...
CREATE TRIGGER guard_workflow_reenrollment BEFORE INSERT ON public.workflow_executions
FOR EACH ROW EXECUTE FUNCTION public.guard_workflow_reenrollment();
