-- SP-0 fix #22: get_segment_benchmark é SECURITY DEFINER sem assert_org_access — assimetria vs as 5 RPCs analytics já guardadas em 20261114000011. Adiciona o guard como primeira instrução (mesma chamada das demais), mantendo a saída agregada/anônima. Ver docs/superpowers/specs/2026-07-02-metrics-foundation-design.md
