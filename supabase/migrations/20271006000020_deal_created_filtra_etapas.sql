-- GitHub #2004 / SCRUM-677
--
-- Etapas restringem globalmente os funis escolhidos. Lista vazia aceita qualquer
-- etapa desses funis; lista presente inválida ou etapa sem funil falha fechado.
...
COMMENT ON FUNCTION public.matches_workflow_trigger_config(text, jsonb, jsonb) IS
  'Filtra gatilhos no banco; deal_created combina funil e etapa congelados.';
