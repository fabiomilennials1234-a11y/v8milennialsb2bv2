...
- **Done when:**
  ...
  - Tooltip info com explicação das dimensões
  - Dark mode correto
...
- **T1.2, T1.3** — Refatorações podem rodar em paralelo com T1.1
...
| Phase 2 | T2.1-T2.4 | Sim | 4 sections, cada uma compõe charts existentes |
