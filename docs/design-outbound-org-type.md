...
- O CLIENTE nunca vê: Campanhas, Equipe, Configurações de roles, quantidade de BDRs
...
| 13 | Dashboards separados por papel | Dashboard único com seções | Cada papel tem foco diferente (prospecção vs resultados) |
