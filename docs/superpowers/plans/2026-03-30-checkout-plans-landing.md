...
VALUES
  ...
  ('torque-2.0', 'Torque 2.0 (Remap)', 'CRM completo com chat, automações e gestão de carteira.', 697, 0, true, false, 2,
  ...
  ('torque-v8', 'Torque V8 (Remap + Turbo)', 'Tudo incluso: CRM, automações, IA e Copilot.', 1997, 0, true, true, 3,
...
5 sections: Conversas, CRM, Automações, IA, Campanhas, Indicadores.
