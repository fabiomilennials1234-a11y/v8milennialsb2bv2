...
**Data:** 2026-03-30
**Status:** Aprovado
**Escopo:** Definição de planos, landing page pública, fluxo de signup/checkout, integração Asaas, provisioning de organizações
...
**Step 3 — Pagamento**
- Duas opções: Cartão de crédito ou PIX
...
- `src/components/landing/FeatureShowcase.tsx` — seções de features
