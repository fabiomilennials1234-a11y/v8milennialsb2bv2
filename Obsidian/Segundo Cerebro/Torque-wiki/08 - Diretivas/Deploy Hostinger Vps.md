...
status: active
source: directives/deploy_hostinger_vps.md
---
...
O MCP Hostinger expoe a ferramenta **VPS_createNewProjectV1**, que sobe um projeto Docker na VPS a partir de um repositório GitHub ou URL do `docker-compose`.
...
4. **Atualizar o deploy (novas versoes)**  
...
- Permissoes: `VPS_PATH` deve ser gravável pelo `VPS_USER`.
