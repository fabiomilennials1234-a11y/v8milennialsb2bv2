...
status: active
source: directives/integrations/api_sync.md
---

# Sincronização de APIs

## Objetivo
Sincronizar dados com APIs externas, fazer pull/push de informaçoes, manter consistência entre sistemas e registrar logs de sincronização.
