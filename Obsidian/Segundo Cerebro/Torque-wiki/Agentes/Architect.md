...
1. **Carregar contexto** - `.specs/codebase/ARCHITECTURE.md`, `.specs/project/STATE.md`, `02 - Arquitetura/`, `04 - Decisoes/`
...
5. **Documentar** - `tlc-spec-driven` pra spec + design. Decisão em `04 - Decisoes/`
