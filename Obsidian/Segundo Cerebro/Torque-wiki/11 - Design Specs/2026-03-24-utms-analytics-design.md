...
status: active
source: docs/superpowers/specs/2026-03-24-utms-analytics-design.md
---
...
- **Matching:** Por ID (campaign_id, adset_id, ad_id) - não por nome, para evitar problemas com renomeaçoes
...
| Nome | Investimento | Impressoes | Cliques | CTR | CPC | Leads | Conversão | CPL | CAC |
