...
status: active
source: docs/superpowers/specs/2026-03-29-scheduled-messages-design.md
---
...
2. Opçoes rápidas de agendamento: "Amanhã 9h", "Em 2 dias 9h", "Próxima segunda 9h", "Em 1 semana 9h"
...
Insere na tabela de alertas/notificaçoes existente (mesmo sistema do `AlertsDropdown`):
...
- `Clock` icon + "Agendar mensagem"
- Posição: após as açoes existentes, antes de "Remover"
