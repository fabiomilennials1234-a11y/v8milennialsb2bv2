...
status: active
source: .specs/features/analytics-marketing-redesign/spec.md
---
...
| 9 | Inconsistência tipográfica - 5 padroes diferentes para labels de métrica | Sofisticação |
...
- **R5.1** Filtros agrupados semanticamente: tempo à esquerda, dimensoes à direita
...
- **NR3** Não alterar permissoes (a tab unificada continua master-only: `isMaster`)
