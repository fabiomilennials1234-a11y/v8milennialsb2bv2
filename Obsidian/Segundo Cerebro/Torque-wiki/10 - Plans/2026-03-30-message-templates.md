...
status: active
source: docs/superpowers/plans/2026-03-30-message-templates.md
---
...
In `src/components/layout/Sidebar.tsx`, add to the `navItems` array at line 102 (after "Automaçoes"):
