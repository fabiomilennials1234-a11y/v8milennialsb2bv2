...
status: active
source: docs/superpowers/plans/2026-03-26-workflow-export-import.md
---
...
export function prepareImport(file: ExportedWorkflowFile): {
  ...
  reportItems.unshift(
    ...
    {
      status: "success",
      message: `${remappedEdges.length} conexoes importadas.`,
    },
    {
      status: "success",
...
describe("prepareImport", () => {
  ...
  it("includes success items for nodes and edges", () => {
    ...
    expect(successItems.some((i) => i.message.includes("conexoes importadas"))).toBe(true);
  });
