...
status: active
source: docs/superpowers/plans/2026-03-18-outbound-org-separation.md
---
...
- No Campanhas, Marketing, Leads, Pódio, Comissoes, Copilot, Automaçoes, Pilotos, Produtos, TV, Pitstop
...
export function useOutboundMetrics() {
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<OutboundMetrics> => {
      ...
      // 3. Reunioes agendadas (pipe_confirmacao entries this month)
...
const cards = [
  ...
  { key: "reunioesAgendadas" as const, prevKey: "reunioesAgendadasPrev" as const, label: "Reunioes Agendadas", icon: Calendar, suffix: "" },
...
const CRITERIA_TYPES = [
  ...
  { value: "reunioes_agendadas", label: "Reunioes agendadas" },
...
- Log in as outbound admin → Configuraçoes shows "Marcos & Badges" tab
...
4. Configuraçoes → "Marcos & Badges" tab visible
...
4. Configuraçoes → NO "Marcos & Badges" tab
