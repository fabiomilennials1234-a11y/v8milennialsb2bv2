...
| `identity` files-per-export | 1.50 | ≥ 3.0 | 2.12 (Fase 9 em curso — 9.2/9.3/9.4a ✅, 9.4 master+demote ✅; 70 files / **33 exports**; sub-pastas `auth/`+`permissions/`+`master/`; 1ª demoção barrel 44→33; org-team move = 9.4b, purga final = 9.5) | idem |
