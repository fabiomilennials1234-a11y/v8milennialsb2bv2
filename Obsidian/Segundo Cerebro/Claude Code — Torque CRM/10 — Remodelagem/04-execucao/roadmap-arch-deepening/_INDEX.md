...
| `identity` files-per-export | 1.50 | ≥ 3.0 | 2.15 (Fase 9 em curso — 9.2/9.3/9.4a/9.4/9.4b ✅; 71 files / **33 exports**; sub-pastas `auth/`+`permissions/`+`master/`+`org-team/`; barrel 44→33 (demote master); purga final org-team PRIV = 9.5 alvo ≤20/≥3.0) | idem |
