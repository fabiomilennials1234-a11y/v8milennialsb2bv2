...
1. **Carrega contexto** — o agente lê `.specs/` e Obsidian conforme definido em suas instruções
...
2. **Obsidian** — Atualizar notas relevantes:
   ...
   - Decisões em `04 — Decisões/` (se decisão arquitetural foi tomada)
3. **STATE.md** — Registrar decisões, blockers, e lições em `.specs/project/STATE.md`
