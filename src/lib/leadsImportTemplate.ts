...
const INSTRUCOES_ROWS: (string | number)[][] = [
  ...
  ["Prioridade do lead", "Não", "Máxima, Alta, Média ou Baixa.", "Alta"],
  ["Público de origem", "Não", "Origem do lead (ex: Site, WhatsApp, Indicação).", "Site"],
  ["Etapa", "Não", "Nome da etapa do funil/campanha (ex: Novo, Abordado, Respondeu). Deve ser igual ao nome da etapa no sistema. Se vazio, usa a etapa padrão escolhida na importação.", "Novo"],
  ["Vendedor", "Não", "Nome do vendedor/responsável (SDR ou Closer). O sistema associa ao vendedor com nome mais parecido na equipe. Se vazio, usa o vendedor padrão escolhido na importação.", "João Silva"],
  ["Temperatura", "Não", "Temperatura/calor do lead de 1 a 10. Usado no funil de Propostas.", "7"],
  ["Valor", "Não", "Valor da proposta em número (ex: 15000 ou R$ 15.000,00). Usado no funil de Propostas.", "15000"],
  ["Produto", "Não", "Nome do(s) produto(s). Vários produtos: separe por vírgula ou ponto e vírgula (ex: Plano Mensal; Plano Anual). O sistema associa ao produto com nome mais parecido no cadastro e vincula todos ao lead. Usado no funil de Propostas.", "Plano Mensal"],
  ["Data Compromisso", "Não", "Data do compromisso/reunião (DD/MM/AAAA ou AAAA-MM-DD). Usado em Propostas e Confirmação.", "15/02/2026"],
