  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const ticket = await createTicket.mutateAsync({
        draft,
        // SupportContext e um shape fixo serializavel; a mutation aceita o
        // saco generico de contexto (Json). O double-cast documenta que o
        // runtime e um Record plano — a interface so nao tem index signature.
        supportContext: captureSupportContext() as unknown as Record<string, unknown>,
      });
