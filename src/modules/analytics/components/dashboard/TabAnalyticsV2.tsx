...
import { KPICard } from "@/modules/analytics/components/dashboard/KPICard";
import { HeroKPICard } from "@/modules/analytics/components/analytics/HeroKPICard";
import { HealthScoreRing, calculateHealthScore } from "@/modules/analytics/components/analytics/HealthScoreRing";
import { InsightCard } from "@/modules/analytics/components/analytics/InsightCard";
import { UnifiedFunnel } from "@/modules/analytics/components/analytics/UnifiedFunnel";
import { AnalyticsFilters } from "@/modules/analytics/components/analytics/AnalyticsFilters";
import { FunnelConversion } from "@/modules/analytics/components/analytics/FunnelConversion";
import { SalesCycleChart } from "@/modules/analytics/components/analytics/SalesCycleChart";
import { RevenueAttribution } from "@/modules/analytics/components/analytics/RevenueAttribution";
import { CohortAnalysis } from "@/modules/analytics/components/analytics/CohortAnalysis";
...
const AquisicaoSection = lazy(() =>
  import("@/modules/analytics/components/analytics/sections/AquisicaoSection").then((m) => ({ default: m.AquisicaoSection }))
);
const PipelineSection = lazy(() =>
  import("@/modules/analytics/components/analytics/sections/PipelineSection").then((m) => ({ default: m.PipelineSection }))
);
const ReceitaSection = lazy(() =>
  import("@/modules/analytics/components/analytics/sections/ReceitaSection").then((m) => ({ default: m.ReceitaSection }))
);
const EquipeSection = lazy(() =>
  import("@/modules/analytics/components/analytics/sections/EquipeSection").then((m) => ({ default: m.EquipeSection }))
);
const UtmsTab = lazy(() =>
  import("@/modules/analytics/components/analytics/tabs/UtmsTab").then((m) => ({ default: m.UtmsTab }))
);
