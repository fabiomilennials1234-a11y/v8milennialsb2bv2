...
import type { CommandPeriod } from "@/modules/analytics/hooks/useCommandMetrics";
...
function CommandHeaderBase({
  month, year, onMonthChange, period, onPeriodChange, onNewLead, showAnalytics, subtitle,
}: CommandHeaderProps) {
  const now = new Date();
