...
- **Agenda** — calendário interno unificado (**5 fontes**: meetings + follow_ups + scheduled_messages + pipe_confirmacao + **meeting_events**, o funil mergeado do ADR-0004/0007). A 5ª entrou no PROD à mão em 30/07/2026 e só foi versionada em `20270827000000`; contagem travada por `tests/unit/agenda-fontes-contract.test.ts`.
