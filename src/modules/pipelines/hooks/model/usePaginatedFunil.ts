  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select(
          "id, organization_id, pipeline_id, stage_key, name, color, position, is_active, is_final_positive, is_final_negative, stage_role, target_pipeline_id, target_stage_id, target_pipe_type, target_stage_key, checklist_template_id, created_at, updated_at",
        )
