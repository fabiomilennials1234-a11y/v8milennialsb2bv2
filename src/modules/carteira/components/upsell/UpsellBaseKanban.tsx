    ...
    <>
      ...
      <div
        ...
        {columns.map((col, colIndex) => {
          const colClients = filteredClients.filter((c) => c.tipo_cliente_tempo === col.id);
      ...
      {isAdmin && (
        <PipeSettingsDialog
          ...
          upsellRulesSlot={<UpsellStageRulesTab stages={stages as PipelineStage[]} />}
          upsellImportSlot={<ImportUpsellClientsContent pipeType="upsell_base" />}
        />
      )}
    </>
  );
