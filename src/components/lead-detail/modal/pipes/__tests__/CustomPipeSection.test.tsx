...
describe("CustomPipeSection", () => {
  it("renders pipe name + current stage in the header", () => {
    gatesMock.mockReturnValue({ canRemoveFromPipe: allowedGate, canMoveMeeting: allowedGate });
    renderSection();
  ...
  it("hides 'Remover' button when canRemoveFromPipe is denied (member)", () => {
    gatesMock.mockReturnValue({ canRemoveFromPipe: deniedGate, canMoveMeeting: allowedGate });
    renderSection();
    expect(
