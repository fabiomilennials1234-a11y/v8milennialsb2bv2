    ...
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          ...
          // Axis & grid — subtle, refined
          "[&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-cartesian-axis-tick_text]:text-[11px] [&_.recharts-cartesian-axis-tick_text]:font-medium",
          "[&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-border/30",
          "[&_.recharts-cartesian-axis-line]:stroke-border/40",
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border bg-popover px-3 py-2 text-xs shadow-lg",
          className,
        )}
      >
