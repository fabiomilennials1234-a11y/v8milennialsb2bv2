...
interface SheetContentProps
  ...
  /** Classes extras para o overlay (ex.: backdrop-blur, dim customizado). */
...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(
  ({ side = "right", className, overlayClassName, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), "z-[51] data-[state=closed]:pointer-events-none", className)} {...props}>
        {children}
