...
// PROTOTYPE — wipe me. Observability cockpit prototype (/master/observability-prototype)
const ObservabilityPrototype = lazy(() => lazyRetry(() => import("@/modules/identity/master/pages/ObservabilityPrototype")));
  ...
  return (
    ...
    <Routes>
      ...
      >
        ...
        {/* PROTOTYPE — wipe me */}
        <Route path="observability-prototype" element={<ObservabilityPrototype />} />
      </Route>
