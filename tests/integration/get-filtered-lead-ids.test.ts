...
const PIPELINE_A_ID = '00000000-0000-0000-0000-0000000705a1';
const PIPELINE_B_ID = '00000000-0000-0000-0000-0000000705b1';
...
describe.skipIf(shouldSkip)('get_filtered_lead_ids RPC', () => {
  ...
  beforeAll(async () => {
    ...
    await supabase.from('pipelines').upsert(
      [
        { id: PIPELINE_A_ID, organization_id: TEST_ORG_ID, name: 'WhatsApp', slug: 'whatsapp', type: 'system' },
        { id: PIPELINE_B_ID, organization_id: TEST_ORG_B_ID, name: 'WhatsApp', slug: 'whatsapp', type: 'system' },
      ],
      { onConflict: 'id' },
    );
