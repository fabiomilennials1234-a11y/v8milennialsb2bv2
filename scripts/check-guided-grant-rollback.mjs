...
const migration = '20271020000000_workflow_data_grants.sql';
...
const conflictMigration = '20271020000001_workflow_grant_revision_conflict.sql';
...
const readerMigration = '20271020000002_guided_condition_authorized_read.sql';
...
const draftMigration = '20271020000003_guided_workflow_drafts.sql';
...
const masterMigration = '20271020000004_guided_workflow_master_authorization.sql';
...
const createMigration = '20271020000005_create_guided_workflow_draft.sql';
...
const settingsMigration = '20271020000006_guided_workflow_draft_settings.sql';
...
const initialSettingsMigration = '20271020000007_create_guided_workflow_draft_settings.sql';
...
const publicationMigration = '20271020000008_guided_workflow_publication.sql';
...
const pinMigration = '20271020000009_guided_execution_version.sql';
...
const discoveryMigration = '20271020000010_guided_publication_discovery.sql';
...
const activationMigration = '20271020000011_guided_activation.sql';
...
const tagAuthorizationMigration = '20271020000015_guided_tag_authorization.sql';
...
const tagPublicationMigration = '20271020000016_guided_tag_publication.sql';
...
const referenceLocationMigration = '20271020000017_guided_reference_locations.sql';
...
const originAuthorizationMigration = '20271020000022_guided_origin_authorization.sql';
...
const responsibleMigration = '20271020000023_guided_personal_responsible_test.sql';
...
const catalogueMigration = '20271020000024_guided_responsible_catalogue.sql';
...
const responsibleReadMigration = '20271020000025_guided_responsible_authorized_read.sql';
...
const responsiblePublicationMigration = '20271020000026_guided_responsible_publication.sql';
...
const customOrgMigration = '20271020000030_guided_custom_field_authorization.sql';
...
const customPublicationMigration = '20271020000031_guided_custom_field_publication.sql';
...
const numericMigration = '20271020000032_guided_custom_numeric_publication.sql';
...
const booleanMigration = '20271020000033_guided_custom_boolean_publication.sql';
...
const dateMigration = '20271020000034_guided_custom_date_publication.sql';
...
const optionsMigration = '20271020000035_guided_personal_custom_options.sql';
...
const selectMigration = '20271020000036_guided_custom_select_publication.sql';
...
const limitMigration = '20271020000037_guided_custom_read_limits.sql';
...
const stageClockMigration = '20271020000038_restart_stage_time_on_funnel_change.sql';
...
const businessPersonalMigration = '20271020000039_guided_personal_trigger_business_stage.sql';
...
const businessAuthorizationMigration = '20271020000040_guided_trigger_business_stage_authorization.sql';
...
const businessVolatilityMigration = '20271020000041_fix_trigger_business_reader_volatility.sql';
...
const businessValueMigration = '20271020000042_guided_trigger_business_value.sql';
...
const businessElapsedMigration = '20271020000043_guided_trigger_business_stage_elapsed.sql';
...
const businessExistenceMigration = '20271020000044_guided_business_existence.sql';
...
const lastWonMigration = '20271020000045_guided_last_won_date.sql';
...
const triggerMessageMigration = '20271020000046_guided_trigger_message_text.sql';
...
const messageCandidatesMigration = '20271020000047_guided_message_test_candidates.sql';
...
const messageCoverageMigration = '20271020000048_guided_message_history_coverage.sql';
...
const messageSearchMigration = '20271020000049_guided_message_text_search.sql';
...
const messageWaitingMigration = '20271020000050_guided_message_waiting_elapsed.sql';
...
const conditionRetryMigration = '20271020000051_guided_condition_retry_state.sql';
...
const historySecurityMigration = '20271020000052_secure_guided_execution_history.sql';
...
const followUpMigration = '20271020000053_guided_follow_up_condition.sql';
...
const productMigration = '20271020000054_guided_product_relation.sql';
...
const workloadLimitsMigration = '20271020000055_guided_workload_limits.sql';
