...
--
-- Rodar DEPOIS de:
--   node scripts/prod-sql-win.mjs --file supabase/migrations/20270901000000_agenda_meeting_events_source.sql
--   node scripts/prod-sql-win.mjs --file supabase/migrations/20270901000010_comando_revoga_anon.sql
--
...
SELECT '20270901000000', 'agenda_meeting_events_source'
WHERE NOT EXISTS (
  SELECT 1 FROM supabase_migrations.schema_migrations WHERE version = '20270901000000'
);

INSERT INTO supabase_migrations.schema_migrations (version, name)
SELECT '20270901000010', 'comando_revoga_anon'
WHERE NOT EXISTS (
  SELECT 1 FROM supabase_migrations.schema_migrations WHERE version = '20270901000010'
);
...
SELECT
  ...
  (SELECT count(*) FROM supabase_migrations.schema_migrations WHERE version = '20270901000000') AS ledger_901000,
  (SELECT count(*) FROM supabase_migrations.schema_migrations WHERE version = '20270901000010') AS ledger_901010;
